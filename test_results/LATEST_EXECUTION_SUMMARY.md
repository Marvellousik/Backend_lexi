...
> **Generated at**: `2026-09-20T15:07:08.226301+00:00`  
...
| **Average Response Latency** | `507.65 ms` | < 500ms Average | ✅ PASS |
...
|---|---|---|---|---|---|---|
| **User & Auth Service** | [`01_user_auth_service.md`](./01_user_auth_service.md) | `6` | `6/6` (100%) | `9.12 ms` | Full Unit Verified | ✅ WORKS |
| **Audio & TTS Service** | [`02_audio_tts_service.md`](./02_audio_tts_service.md) | `3` | `3/3` (100%) | `3441.28 ms` | Full Unit Verified | ✅ WORKS |
| **Content & PDF Ingestion** | [`03_content_pdf_service.md`](./03_content_pdf_service.md) | `3` | `3/3` (100%) | `3.85 ms` | Full Unit Verified | ✅ WORKS |
| **Reading & Summarizer** | [`04_reading_summarization_service.md`](./04_reading_summarization_service.md) | `2` | `2/2` (100%) | `0.13 ms` | Full Unit Verified | ✅ WORKS |
...
| **Timetable & Event Manager** | [`06_timetable_event_service.md`](./06_timetable_event_service.md) | `3` | `3/3` (100%) | `3.15 ms` | Full Unit Verified | ✅ WORKS |
| **Proactive Engine & Today Feed** | [`07_proactive_today_feed.md`](./07_proactive_today_feed.md) | `3` | `3/3` (100%) | `4.33 ms` | Full Unit Verified | ✅ WORKS |
| **Unified AI Gateway & OpenRouter** | [`08_ai_gateway_openrouter_service.md`](./08_ai_gateway_openrouter_service.md) | `2` | `2/2` (100%) | `259.24 ms` | Full Unit Verified | ✅ WORKS |
| **End-to-End Lifecycle** | [`09_end_to_end_lifecycle.md`](./09_end_to_end_lifecycle.md) | `1` | `1/1` (100%) | `2267.55 ms` | Full Unit Verified | ✅ WORKS |
