-- ==============================================================================
-- Migration: 012_create_programs_and_cohorts.sql
-- Description: Academic Programs, Cohorts, Course Offerings, and Enhanced Student Enrollments
-- ==============================================================================

CREATE SCHEMA IF NOT EXISTS zuri_academic;
CREATE SCHEMA IF NOT EXISTS academic;

-- 1. Academic Programs (Degrees and Disciplines administered by Departments)
...
-- 5. Backward Compatible Views for academic schema
