...
CREATE INDEX IF NOT EXISTS idx_quiz_questions_order_index ON zuri_content.quiz_questions(quiz_id, order_index);
...
CREATE INDEX IF NOT EXISTS idx_flashcards_order_index ON zuri_content.flashcards(deck_id, order_index);
