-- Migration: supabase/011_create_institution_memberships_zuri.sql
-- Description: Institutional Memberships, Roles, Permissions for Supabase / zuri_auth schema
...
CREATE TABLE IF NOT EXISTS zuri_auth.institution_memberships (
    ...
    CONSTRAINT uq_user_institution_supabase UNIQUE (user_id, institution_id)
);
